...
class Common(Configuration):
    ...
    SECRET_KEY = os.getenv('DJANGO_SECRET_KEY', '9!*9x#p+7u05)tip!3d^cr24*4xagwsns0m@ackh!^-6_w773k')
    ...
    REDIS_URL = os.getenv('DJANGO_REDIS_URL', 'redis://redis:6379/1')
